...
function renderUI(shadowRoot, isPremium) {
    ...
    // Score Container
    h('div', { className: 'score-container' }, h('div', { className: 'score-circle', style: 'color: ' + color }, score + '%'), h('div', { className: 'conclusion' }, conclusion)), 
    // Details Section
    h('div', { className: 'details-section' }, h('div', { className: isPremium ? '' : 'premium-blur' }, h('div', { style: 'font-size: 11px; color:#71717a; margin-bottom: 8px; font-weight:600;' }, '상세 팩트체크 근거'), ...reasonsNodes), !isPremium ? h('div', { className: 'premium-overlay' }, h('div', { className: 'premium-lock-icon' }, '🔒'), h('button', {
